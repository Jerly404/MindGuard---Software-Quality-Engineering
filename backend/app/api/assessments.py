...
def level_to_score(level: str) -> int:
    ...
    if "alto" in level or "grave" in level: return 18
    if "medio" in level or "moderado" in level: return 10
    if "leve" in level or "bajo" in level: return 5
    return 0
...
async def chat_evaluation(
    *,
    ...
    try:
        ...
        return {"resumen": "Sesión finalizada.", "nivel_ansiedad": "Bajo", "nivel_depresion": "Bajo", "puntos_clave": [], "recomendacion_profesional": "Sigue así.", "plan_accion": []}
